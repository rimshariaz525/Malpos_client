  ...
  const fetchAllergyData = async () => {
    try {
      ...
      if (response && response.data) {
        ...
        const formattedClients = formatData([{ cd_client_id }], "cd_client_id");
        const formattedBrands = formatData([{ cd_brand_id }], "cd_brand_id");
        const formattedBranches = formatData([{ cd_branch_id }], "cd_branch_id");
        formik.setValues({
          cd_client_id: formattedClients,
          cd_brand_id: formattedBrands,
          cd_branch_id: formattedBranches,
